...
$(document).ready(function () {
    ...
    function apex_chart_one() {
        ...
        var options = {
            ...
            grid: {
                show: true,
                borderColor: $('body').hasClass('dark') ? '#50535a' : '#dbdbdb',
            },
            series: [{
                data: data
            }],
    ...
    function apex_chart_six() {
        var options = {
            ...
            stroke: {
                width: 1,
                colors: [$('body').hasClass('dark') ? '#383a3f' : 'white'],
            },
            xaxis: {
    ...
    function apex_chart_nine() {
        var options = {
            ...
            scaleLineColor: $('body').hasClass('dark') ? '#50535a' : '#dbdbdb',
            legend: {
                show: false
            },
            plotOptions: {
                radar: {
                    polygons: {
                        strokeColors: $('body').hasClass('dark') ? '#50535a' : '#dbdbdb',
                        connectorColors: $('body').hasClass('dark') ? '#50535a' : '#dbdbdb',
                        fill: {
                            colors: [$('body').hasClass('dark') ? '#383a3f' : 'white']
                        }
                    }
